...
const Index = () => {
  ...
  return <div className="min-h-screen bg-white">
      ...
      <section className="pt-20 pb-12 md:pt-24 md:pb-16 bg-white">
        <div className="container-custom">
          <div className="text-center space-y-6 md:space-y-8 max-w-4xl mx-auto">
            {/* Headline */}
            <h1 className="font-montserrat font-bold text-black leading-tight">
              Tired of Agencies That Pocket Your Retainer{' '}
              <span className="text-gold">&</span> Deliver Mediocre Results?
            </h1>
            
            {/* Subheadline */}
            <p className="text-lg md:text-xl text-black leading-relaxed">
                Most marketing agencies collect their $5K/month and hope you don't notice the leads never come. 
                <span className="font-bold text-black"> We're not most agencies.</span> Full-funnel ownership. 
                Real growth. Month-to-month. You walk if we don't deliver.
              </p>
              
            {/* Trust Stack */}
            <div className="space-y-3 text-left max-w-2xl mx-auto px-4 md:px-0">
              <div className="flex items-center gap-3">
                <CheckCircle className="text-[hsl(var(--green-success))] w-5 h-5" />
                <span className="font-semibold">30M+ Views Generated</span> in Last 90 Days (We Know Organic + Paid)
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="text-[hsl(var(--green-success))] w-5 h-5" />
                <span className="font-semibold">Month-to-Month Only</span> (No 12-Month Prison Sentences)
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="text-[hsl(var(--green-success))] w-5 h-5" />
                <span className="font-semibold">You Own Everything</span> (Accounts, Creative, Data—Forever)
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="text-[hsl(var(--green-success))] w-5 h-5" />
                <span className="font-semibold">30-Day Out Clause</span> (Walk If We Don't Perform)
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <button onClick={scrollToProof} className="text-black underline hover:text-gold transition-colors">
      ...
      <section id="how-it-works" className="section-padding bg-light-gray">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h2 className="font-montserrat font-bold text-black">
      ...
      <section id="apply" className="section-padding bg-navy text-white">
        <div className="container-custom text-center">
          ...
          <div className="space-y-6">
            <Button onClick={() => window.open('mailto:hello@amplomarketing.com?subject=Partnership Application', '_blank')} className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-primary/90 h-10 btn-primary text-2xl px-16 py-6 bg-[rgb(255,110,110)] text-[rgb(255,255,255)]">
            ...
            <Button onClick={() => window.open('mailto:hello@amplomarketing.com?subject=Partnership Application', '_blank')} className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 btn-primary bg-[rgb(255,110,110)]">
      ...
      <footer className="bg-dark-gray text-white py-16">
        <div className="container-custom">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <div className="text-2xl font-montserrat font-bold mb-4">AMPLO</div>
